# Contributing to AIBP

Thank you for your interest in contributing to the AI Bot Protocol! This document provides guidelines for contributing to the project.

## How to Contribute

### Reporting Issues

- Use [GitHub Issues](https://github.com/AIBP-Protocol/AIBP/issues) to report bugs, suggest features, or propose specification changes
...
Examples:
- `spec(trust): add T4 Partner trust level requirements`
- `docs(guide): add email setup guide for Gmail`
- `fix(spec): correct INTRODUCE message format example`

### Bilingual Requirements

For specification changes:
- English version (`specification/AIBP_Protocol.md`) and Chinese version (`specification/AIBP_Protocol_cn.md`) must be updated in the same PR
- Axiom 0 in Chinese: "人类主权和福祉" (never abbreviated)
...
- Open a [GitHub Discussion](https://github.com/AIBP-Protocol/AIBP/discussions) for general questions
- For private inquiries, open a [Security Advisory](https://github.com/AIBP-Protocol/AIBP/security/advisories/new)
